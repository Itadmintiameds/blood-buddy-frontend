        ...
        {!loading &&
          filteredBloodBanks.map((bank, index) => (
            <BloodBankCard
              ...
              onAddStock={(availabilityId) => openAddStockModal(bank, availabilityId)}
            />
          ))}
      </div>
      ...
      >
        ...
        <div className="overflow-y-auto px-5 py-5">
          ...
          <p className="mt-3 text-[12px] text-[var(--color-text-placeholder-alt)]">
            Current stock: <span className="font-bold text-[var(--color-text-body)]">{availability?.units} units</span>
          </p>
